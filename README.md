...
- **Turn-end question check**: A final paragraph containing `?` outside URLs and inline code in a Claude or Codex response shows an attached brief as blocked with that paragraph as the ask, without changing the brief file
